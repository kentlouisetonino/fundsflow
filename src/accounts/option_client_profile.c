...
void option_client_profile(bank_account *accounts) {
  ...
  while (1) {
    ...
    add_new_tab();
    add_new_tab();
    printf("%s Client Profile%s", GREEN, RESET);
    add_new_line();
    add_new_line();
    add_new_tab();
    printf("%s-----------------------------------------%s", BLUE, RESET);
    ...
    add_new_tab();
    printf("%sAccount Address:%s %s%s%s", BLUE, RESET, GREEN,
           account.account_address, RESET);
    add_new_line();

    // Display account birthday.
    add_new_tab();
    printf("%sAccount Birthday:%s %s%s%s", BLUE, RESET, GREEN,
           account.account_birthday, RESET);
    add_new_line();

    // Display contact number.
    add_new_tab();
    printf("%sContact Number:%s %s%d%s", BLUE, RESET, GREEN,
           account.contact_number, RESET);
    add_new_line();
